...
function teachers() {
	$labels = array(
		...
		'add_new'            => _x( 'Add New', 'teacher item' ),
		...
		'search_items'       => __( 'Search all teachers' ),
	...
	$args = array(
		'labels'        => $labels,
		'description'   => 'Holds our teachers and charter specific data',
		'public'        => true,
		'menu_position' => 5,
...
/* CUSTOM POST TYPE FOR TEACHER TRAININGS */

add_action( 'init', 'teacher_trainings' );

function teacher_trainings() {
	$labels = array(
		'name'               => _x( 'teacher training', 'post type general name' ),
		'singular_name'      => _x( 'teacher training', 'post type singular name' ),
		'add_new'            => _x( 'Add New', 'teacher training item' ),
		'add_new_item'       => __( 'Add New teacher training' ),
		'edit_item'          => __( 'Edit teacher training' ),
		'new_item'           => __( 'New teacher training' ),
		'all_items'          => __( 'All teacher trainings' ),
		'view_item'          => __( 'View teacher training' ),
		'search_items'       => __( 'Search all teacher trainings' ),
		'not_found'          => __( 'No teacher trainings found' ),
		'not_found_in_trash' => __( 'No teacher trainings found in the Trash' ), 
		'parent_item_colon'  => '',
		'menu_name'          => 'teacher training'
		
	);
	$args = array(
		'labels'        => $labels,
		'description'   => 'Holds our teacher trainings and charter specific data',
		'public'        => true,
		'menu_position' => 5,
		'supports'      => array( 'title', 'editor', 'thumbnail', 'excerpt', 'custom-fields', 'categories' ),
		'has_archive'   => true,
	...
	register_post_type( 'teacher_trainings', $args );	
	add_theme_support('post-thumbnails');	

}

/* CUSTOM POST TYPE FOR RETREATS */

add_action( 'init', 'retreats' );

function retreats() {
	$labels = array(
		'name'               => _x( 'retreat', 'post type general name' ),
		'singular_name'      => _x( 'retreat', 'post type singular name' ),
		'add_new'            => _x( 'Add New', 'retreat item' ),
		'add_new_item'       => __( 'Add New retreat' ),
		'edit_item'          => __( 'Edit retreat' ),
		'new_item'           => __( 'New retreat' ),
		'all_items'          => __( 'All retreats' ),
		'view_item'          => __( 'View retreat' ),
		'search_items'       => __( 'Search all retreats' ),
		'not_found'          => __( 'No retreats found' ),
		'not_found_in_trash' => __( 'No retreats found in the Trash' ), 
		'parent_item_colon'  => '',
		'menu_name'          => 'retreat'
	...
	$args = array(
		'labels'        => $labels,
		'description'   => 'Holds our retreats and charter specific data',
		'public'        => true,
		'menu_position' => 5,
		'supports'      => array( 'title', 'editor', 'thumbnail', 'excerpt', 'custom-fields', 'categories' ),
		'has_archive'   => true,
...
if ( function_exists( 'add_theme_support' ) ) {
	add_theme_support( 'post-thumbnails' );
        set_post_thumbnail_size( 300, 300, true );
        add_image_size( 'small', 300, 300, true );
        add_image_size( 'large', 1600, 670, false );
}
